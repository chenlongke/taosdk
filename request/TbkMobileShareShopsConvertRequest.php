<?php
/**
 * TOP API: taobao.tbk.mobile.share.shops.convert request
 * 
 * @author auto create
 * @since 1.0, 2013-11-01 00:00:00
 */
class TbkMobileShareShopsConvertRequest
{
	/** 
	 * 需返回的字段列表.可选值click_url.
	 **/
	private $fields;
...
注意：sids和seller_nicks两个参数任意必须输入一个，如果同时输入，则以seller_nicks为准
	...
	{
		return "taobao.tbk.mobile.share.shops.convert";
	}
