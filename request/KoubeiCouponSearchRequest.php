...
比如：offer_hits,DESC
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->orderBy,30,"orderBy");
		...
		RequestCheckUtil::checkMaxValue($this->periRange,10000,"periRange");
		RequestCheckUtil::checkMinValue($this->periRange,0,"periRange");
		RequestCheckUtil::checkMaxLength($this->q,20,"q");
		RequestCheckUtil::checkMaxLength($this->storeId,35,"storeId");
		RequestCheckUtil::checkMaxValue($this->subCate,99999,"subCate");
		RequestCheckUtil::checkMinValue($this->subCate,1,"subCate");
