<?php
/**
 * TOP API: taobao.logistics.partner.ordertrace.push request
 * 
 * @author auto create
 * @since 1.0, 2012-08-28 00:00:00
 */
class LogisticsPartnerOrdertracePushRequest
{
	/** 
	 * 物流公司名称
	 **/
	...
	public function setNextFacility($nextFacility)
	{
		$this->nextFacility = $nextFacility;
		$this->apiParas["next_facility"] = $nextFacility;
	}

	public function getNextFacility()
	{
	...
	{
		return "taobao.logistics.partner.ordertrace.push";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->nextFacility,100,"nextFacility");
