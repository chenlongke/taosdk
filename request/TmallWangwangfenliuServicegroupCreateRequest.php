<?php
/**
 * TOP API: tmall.wangwangfenliu.servicegroup.create request
 * 
 * @author auto create
 * @since 1.0, 2012-12-25 00:00:00
 */
class TmallWangwangfenliuServicegroupCreateRequest
{
	/** 
	 * 服务分组名称
	 **/
	...
	{
		return "tmall.wangwangfenliu.servicegroup.create";
	}
