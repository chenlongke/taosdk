...
class TicketItemUpdateRequest
{
	...
	/** 
	 * 电子凭证业务属性（consume_way代表核销方式，4为身份证核销）
	 **/
	private $etcEticketProps;
...
<pre>
{
  "SKU":
	...
	public function setEtcEticketProps($etcEticketProps)
	{
		$this->etcEticketProps = $etcEticketProps;
		$this->apiParas["etc.eticket_props"] = $etcEticketProps;
	}

	public function getEtcEticketProps()
	{
		return $this->etcEticketProps;
	}
