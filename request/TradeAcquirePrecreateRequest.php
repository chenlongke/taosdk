<?php
/**
 * TOP API: taobao.trade.acquire.precreate request
 * 
 * @author auto create
 * @since 1.0, 2014-02-26 00:00:00
 */
class TradeAcquirePrecreateRequest
{
	/** 
	 * 品牌价格列表，多个以用'θ'做分隔符
...
单个商品价格是Number(11)的正整数，【目前暂时最多支持传入一个商品】
	 **/
	private $goodsPrices;
...
单个商品数量int(11)，【目前暂时最多支持传入一个商品的信息】
	...
	/** 
	 * 订单标题（不超过64个字符）；如果不给出商品信息，订单标题作为商品名来下单；这里可传入第一个商品名作为订单标题
	 **/
	private $subject;
	...
	{
		return "taobao.trade.acquire.precreate";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMinValue($this->couponsConsume,1,"couponsConsume");
