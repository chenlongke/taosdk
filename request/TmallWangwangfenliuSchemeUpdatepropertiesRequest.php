<?php
/**
 * TOP API: tmall.wangwangfenliu.scheme.updateproperties request
 * 
 * @author auto create
 * @since 1.0, 2013-04-22 00:00:00
 */
class TmallWangwangfenliuSchemeUpdatepropertiesRequest
{
	/** 
	 * 分流方案的属性
	 **/
	...
	{
		return "tmall.wangwangfenliu.scheme.updateproperties";
	}
