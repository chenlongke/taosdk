<?php
/**
 * TOP API: taobao.jindoucloud.message.authorize.permit request
 * 
 * @author auto create
 * @since 1.0, 2013-12-31 00:00:00
 */
class JindoucloudMessageAuthorizePermitRequest
{
	/** 
	 * 客户端的版本信息
	 **/
	...
	{
		return "taobao.jindoucloud.message.authorize.permit";
	}
