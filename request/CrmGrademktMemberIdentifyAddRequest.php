<?php
/**
 * TOP API: taobao.crm.grademkt.member.identify.add request
 * 
 * @author auto create
 * @since 1.0, 2012-12-05 00:00:00
 */
class CrmGrademktMemberIdentifyAddRequest
{
	/** 
	 * 会员nick
	 **/
	...
	/** 
	 * 会员属性，json格式，生成方法见
http://open.taobao.com/doc/detail.htm?id=101281
	 **/
	private $parameter;
	...
	{
		return "taobao.crm.grademkt.member.identify.add";
	}
