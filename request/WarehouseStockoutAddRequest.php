...
class WarehouseStockoutAddRequest
{
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->exceptCrkDate,"exceptCrkDate");
		...
		RequestCheckUtil::checkMaxLength($this->sellerContactor,10,"sellerContactor");
		...
		RequestCheckUtil::checkNotNull($this->transportContactor,"transportContactor");
		RequestCheckUtil::checkNotNull($this->transportContactorPhone,"transportContactorPhone");
