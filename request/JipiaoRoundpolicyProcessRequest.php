<?php
/**
 * TOP API: taobao.jipiao.roundpolicy.process request
 * 
 * @author auto create
 * @since 1.0, 2012-09-12 00:00:00
 */
class JipiaoRoundpolicyProcessRequest
{
	/** 
	 * 政策所支持的航空公司二字码
	 **/
...
默认为1234567
	 **/
	private $backDayOfWeeks;
	
	/** 
	 * 政策回程旅行有效日期中排除指定日期，设定日期将不在搜索结果页面展现 注：最多排除20天，特殊政策无此设置
	 **/
	private $backExcludeDate;
	
	/** 
	 * 回程航班起飞时间点开始时间，默认00:00
	 **/
	private $backFirstDepTimeOfDay;
	
	/** 
	 * 包含/排除的航班号，注意格式： +CA1234,CZ3166，表示包含列表 -CA1234,CZ3166，表示排除列表 默认包含所有航班； 不支持同时包含和排除
	 **/
	private $backFlightInfo;
	
	/** 
	 * 回程航班起飞时间点结束时间，默认23:59
	 **/
	private $backLastDepTimeOfDay;
	
	/** 
	 * 政策回程旅行有效日期的结束日期(注意，格式如：20120-03-10 10:30:31 等价2012-03-11)
	 **/
	private $backTravelEndDate;
	
	/** 
	 * 政策回程旅行有效日期的开始日期(注意，格式，如：2012-03-10 10:30:31 等价2012-03-10)
	 **/
	private $backTravelStartDate;
	
	/** 
	 * @1: [{"matcher":{"mode":"INCLUDE","list":["Y","B"]},"priceStrategy":{"mode":"DISCOUNT","modeBaseValue":null,"retention":5000,"rebase":-5},"backMatcher":{"mode":"INCLUDE","list":["D","E"]}}]

@2: [{"matcher":{"mode":"INCLUDE","list":["Y"]},"priceStrategy":{"mode":"TICKET_PRICE","modeBaseValue":1000,"retention":5000,"rebase":-5},"backMatcher":{"mode":"INCLUDE","list":["D"]}}]

规则说明： cabin_rules分三个字段：matcher:适应舱位(又包含两个字段：mode：匹配模式枚举(填INCLUDE)，list：适应舱位列表)；backMatcher:回程适应舱位(又包含两个字段：mode：匹配模式枚举(填INCLUDE)，list：适应舱位列表)；priceStrategy:价格策略(mode:价格模式(让利产品：DISCOUNT，特价产品：票面价TICKET_PRICE)；modeBaseValue:当价格模式mode为DISCOUNT，modeBaseValue不填；当价格模式mode为TICKET_PRICE，modeBaseValue填票面价；retention为返点的百分比；rebase为留钱)
	 **/
	private $cabinRules;
...
注：最多排除20天，特殊政策无此设置
	...
	/** 
	 * FDMode：0，只支持单程两个FD两加；1，只支持往返FD；2，单程两个FD两加和往返FD都支持，优先使用往返FD；默认1。注意：让利往返政策, FDMode支持0，1，2；特价往返政策，FDMode只支持1
	 **/
	private $fdMode;
...
2，type为2时，表示policy_id为政策out_product_id
	 ...
	 * 旅行要求最大停留天数；默认-1表示无效
	 **/
	private $travelStayMaxDay;
	
	/** 
	 * 旅行要求最小停留天数；默认-1表示无效
	 **/
	private $travelStayMinDay;
...
2，表示按out_product_id修改政策
	...
	public function setBackDayOfWeeks($backDayOfWeeks)
	{
		$this->backDayOfWeeks = $backDayOfWeeks;
		$this->apiParas["back_day_of_weeks"] = $backDayOfWeeks;
	}

	public function getBackDayOfWeeks()
	{
		return $this->backDayOfWeeks;
	}

	public function setBackExcludeDate($backExcludeDate)
	{
		$this->backExcludeDate = $backExcludeDate;
		$this->apiParas["back_exclude_date"] = $backExcludeDate;
	}

	public function getBackExcludeDate()
	{
		return $this->backExcludeDate;
	}

	public function setBackFirstDepTimeOfDay($backFirstDepTimeOfDay)
	{
		$this->backFirstDepTimeOfDay = $backFirstDepTimeOfDay;
		$this->apiParas["back_first_dep_time_of_day"] = $backFirstDepTimeOfDay;
	}

	public function getBackFirstDepTimeOfDay()
	{
		return $this->backFirstDepTimeOfDay;
	}

	public function setBackFlightInfo($backFlightInfo)
	{
		$this->backFlightInfo = $backFlightInfo;
		$this->apiParas["back_flight_info"] = $backFlightInfo;
	}

	public function getBackFlightInfo()
	{
		return $this->backFlightInfo;
	}

	public function setBackLastDepTimeOfDay($backLastDepTimeOfDay)
	{
		$this->backLastDepTimeOfDay = $backLastDepTimeOfDay;
		$this->apiParas["back_last_dep_time_of_day"] = $backLastDepTimeOfDay;
	}

	public function getBackLastDepTimeOfDay()
	{
		return $this->backLastDepTimeOfDay;
	}

	public function setBackTravelEndDate($backTravelEndDate)
	{
		$this->backTravelEndDate = $backTravelEndDate;
		$this->apiParas["back_travel_end_date"] = $backTravelEndDate;
	}

	public function getBackTravelEndDate()
	{
		return $this->backTravelEndDate;
	}

	public function setBackTravelStartDate($backTravelStartDate)
	{
		$this->backTravelStartDate = $backTravelStartDate;
		$this->apiParas["back_travel_start_date"] = $backTravelStartDate;
	}

	public function getBackTravelStartDate()
	{
		return $this->backTravelStartDate;
	}
	...
	public function setFdMode($fdMode)
	{
		$this->fdMode = $fdMode;
		$this->apiParas["fd_mode"] = $fdMode;
	}

	public function getFdMode()
	{
		return $this->fdMode;
	}

	public function setFirstDepTimeOfDay($firstDepTimeOfDay)
	{
		$this->firstDepTimeOfDay = $firstDepTimeOfDay;
		$this->apiParas["first_dep_time_of_day"] = $firstDepTimeOfDay;
	}

	public function getFirstDepTimeOfDay()
	{
		return $this->firstDepTimeOfDay;
	}
	...
	public function setLastDepTimeOfDay($lastDepTimeOfDay)
	{
		$this->lastDepTimeOfDay = $lastDepTimeOfDay;
		$this->apiParas["last_dep_time_of_day"] = $lastDepTimeOfDay;
	}

	public function getLastDepTimeOfDay()
	{
		return $this->lastDepTimeOfDay;
	}
	...
	public function setTravelStayMaxDay($travelStayMaxDay)
	{
		$this->travelStayMaxDay = $travelStayMaxDay;
		$this->apiParas["travel_stay_max_day"] = $travelStayMaxDay;
	}

	public function getTravelStayMaxDay()
	{
		return $this->travelStayMaxDay;
	}

	public function setTravelStayMinDay($travelStayMinDay)
	{
		$this->travelStayMinDay = $travelStayMinDay;
		$this->apiParas["travel_stay_min_day"] = $travelStayMinDay;
	}

	public function getTravelStayMinDay()
	{
		return $this->travelStayMinDay;
	}
	...
	{
		return "taobao.jipiao.roundpolicy.process";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->backDayOfWeeks,7,"backDayOfWeeks");
		RequestCheckUtil::checkMaxLength($this->backExcludeDate,200,"backExcludeDate");
		RequestCheckUtil::checkMaxLength($this->backFirstDepTimeOfDay,4,"backFirstDepTimeOfDay");
		RequestCheckUtil::checkMaxLength($this->backFlightInfo,1000,"backFlightInfo");
		RequestCheckUtil::checkMaxLength($this->backLastDepTimeOfDay,4,"backLastDepTimeOfDay");
		RequestCheckUtil::checkNotNull($this->backTravelEndDate,"backTravelEndDate");
		RequestCheckUtil::checkNotNull($this->backTravelStartDate,"backTravelStartDate");
		...
		RequestCheckUtil::checkMaxLength($this->ei,12,"ei");
		RequestCheckUtil::checkMaxLength($this->excludeDate,200,"excludeDate");
		RequestCheckUtil::checkNotNull($this->fdMode,"fdMode");
		RequestCheckUtil::checkMaxValue($this->fdMode,2,"fdMode");
		RequestCheckUtil::checkMinValue($this->fdMode,0,"fdMode");
		RequestCheckUtil::checkMaxLength($this->firstDepTimeOfDay,4,"firstDepTimeOfDay");
		RequestCheckUtil::checkMaxLength($this->flightInfo,1000,"flightInfo");
		RequestCheckUtil::checkMaxLength($this->lastDepTimeOfDay,4,"lastDepTimeOfDay");
