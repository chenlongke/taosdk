<?php
/**
 * TOP API: taobao.elearning.teacher.add request
 * 
 * @author auto create
 * @since 1.0, 2012-06-14 00:00:00
 */
class ElearningTeacherAddRequest
{
	/** 
	 * 讲师头像地址
	 **/
	...
	{
		return "taobao.elearning.teacher.add";
	}
