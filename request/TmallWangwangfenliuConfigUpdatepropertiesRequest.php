<?php
/**
 * TOP API: tmall.wangwangfenliu.config.updateproperties request
 * 
 * @author auto create
 * @since 1.0, 2013-09-02 00:00:00
 */
class TmallWangwangfenliuConfigUpdatepropertiesRequest
{
	/** 
	 * 以JSON格式提供的全局配置项键值对
	 **/
	...
	{
		return "tmall.wangwangfenliu.config.updateproperties";
	}
