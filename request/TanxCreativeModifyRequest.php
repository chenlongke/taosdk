<?php
/**
 * TOP API: taobao.tanx.creative.modify request
 * 
 * @author auto create
 * @since 1.0, 2014-01-06 00:00:00
 */
class TanxCreativeModifyRequest
{
	/** 
	 * 创意代码,如果这个参数为null，那么表示这个字段不修改
	 **/
	private $adboardData;
	
	/** 
	 * 创意尺寸,中间以小写字母x分隔,如果这个参数为null，那么表示这个字段不修改
	 **/
	private $adboardSize;
	
	/** 
	 * 广告类目 如果有多个，以逗号分隔,如果这个参数为null，那么表示这个字段不修改
	 **/
	private $adboardType;
	...
	/** 
	 * 敏感词类目，多个的话以逗号分隔，,如果这个参数为null，那么表示这个字段不修改，如果想清空敏感词类目，那么传空字符串""
	 **/
	...
	{
		return "taobao.tanx.creative.modify";
	}
