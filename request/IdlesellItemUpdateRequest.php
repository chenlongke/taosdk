<?php
/**
 * TOP API: taobao.idlesell.item.update request
 * 
 * @author auto create
 * @since 1.0, 2012-11-23 00:00:00
 */
class IdlesellItemUpdateRequest
{
	/** 
	 * 商品所在地区，当所在城市下存在地区，地区必须传递。
	 **/
	private $area;
...
&attribute=weibo_id:1564266095;weibo_nick:ibohao;weibo_auth:1;weibo_auth_detail:觅我信息创始人朱志;weibo_user_sex:男&other_param=xxx
	...
	/** 
	 * 宝贝标签（关键字）。逗号分割，最多5个标签，每个标签最多7个汉字。宝贝标签作用于宝贝搜索，提高搜索的相关性。
	 **/
	private $tags;
	...
	{
		return "taobao.idlesell.item.update";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxLength($this->increment,15,"increment");
