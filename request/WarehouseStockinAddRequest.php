...
class WarehouseStockinAddRequest
{
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->expectCrkDate,"expectCrkDate");
		...
		RequestCheckUtil::checkNotNull($this->totalPackage,"totalPackage");
		...
		RequestCheckUtil::checkNotNull($this->transportNo,"transportNo");
