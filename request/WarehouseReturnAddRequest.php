...
REASON_OTHER  -- 其他
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->buyerAddress,"buyerAddress");
		RequestCheckUtil::checkMaxLength($this->buyerAddress,128,"buyerAddress");
		RequestCheckUtil::checkNotNull($this->buyerContactor,"buyerContactor");
		RequestCheckUtil::checkMaxLength($this->buyerContactor,64,"buyerContactor");
		RequestCheckUtil::checkNotNull($this->buyerPhone,"buyerPhone");
		RequestCheckUtil::checkMaxLength($this->buyerPhone,32,"buyerPhone");
		RequestCheckUtil::checkNotNull($this->contactExpressMode,"contactExpressMode");
		RequestCheckUtil::checkNotNull($this->options,"options");
		...
		RequestCheckUtil::checkMaxListSize($this->planCount,500,"planCount");
		RequestCheckUtil::checkMaxListSize($this->remarks,500,"remarks");
		RequestCheckUtil::checkNotNull($this->returnReason,"returnReason");
		RequestCheckUtil::checkMaxLength($this->returnReason,256,"returnReason");
		RequestCheckUtil::checkNotNull($this->returnReasonCode,"returnReasonCode");
		RequestCheckUtil::checkNotNull($this->sellerContactor,"sellerContactor");
		RequestCheckUtil::checkMaxLength($this->sellerContactor,32,"sellerContactor");
		RequestCheckUtil::checkNotNull($this->sellerPhone,"sellerPhone");
		RequestCheckUtil::checkMaxLength($this->sellerPhone,64,"sellerPhone");
		RequestCheckUtil::checkNotNull($this->transportName,"transportName");
		RequestCheckUtil::checkMaxLength($this->transportName,128,"transportName");
		RequestCheckUtil::checkMaxLength($this->transportNo,64,"transportNo");
	}
