<?php
/**
 * TOP API: tmall.wangwangfenliu.servicegroup.updateproperties request
 * 
 * @author auto create
 * @since 1.0, 2013-01-24 00:00:00
 */
class TmallWangwangfenliuServicegroupUpdatepropertiesRequest
{
	/** 
	 * 服务分组名称
	 **/
	...
	{
		return "tmall.wangwangfenliu.servicegroup.updateproperties";
	}
