<?php
/**
 * TOP API: taobao.uz.content.publish request
 * 
 * @author auto create
 * @since 1.0, 2013-10-13 00:00:00
 */
class UzContentPublishRequest
{
	/** 
	...
	{
		return "taobao.uz.content.publish";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkMaxValue($this->type,3,"type");
