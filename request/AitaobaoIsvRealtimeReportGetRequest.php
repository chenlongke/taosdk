<?php
/**
 * TOP API: taobao.aitaobao.isv.realtime.report.get request
 * 
 * @author auto create
 * @since 1.0, 2014-01-16 00:00:00
 */
class AitaobaoIsvRealtimeReportGetRequest
{
	/** 
...
以用户输入的start_time时间为起始时间，start_time+span为结束时间，查询该时间段内的订单。span最小值为60秒，最大值为600秒，默认值为60秒
	...
	/** 
	 * 创建CREATED(11),付款PAIDDONE(12),关闭CLOSED(13),收货SUCCESS(14),结算成功SETTLESUCCESS(3)
	 **/
	private $status;
	...
	{
		return "taobao.aitaobao.isv.realtime.report.get";
	}
