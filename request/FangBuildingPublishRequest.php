<?php
/**
 * TOP API: taobao.fang.building.publish request
 * 
 * @author auto create
 * @since 1.0, 2013-08-12 00:00:00
 */
class FangBuildingPublishRequest
{
	/** 
	 * 楼盘所在区域
	 **/
	...
	public function setAreaName($areaName)
	{
		...
		$this->apiParas["area_name"] = $areaName;
	}
	...
	public function setBuildingAlias($buildingAlias)
	{
		$this->buildingAlias = $buildingAlias;
		$this->apiParas["building_alias"] = $buildingAlias;
	}

	public function getBuildingAlias()
	{
	...
	{
		return "taobao.fang.building.publish";
	}
	...
	public function check()
	{
		...
		RequestCheckUtil::checkNotNull($this->areaName,"areaName");
